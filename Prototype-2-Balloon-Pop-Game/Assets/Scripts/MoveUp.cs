...
public class MoveUp : MonoBehaviour
{
    ...
    public float upperBound = 40.0f;
    public ScoreManager scoreManager; // References the scoremananger
    public Balloon balloon; // References the balloon script to get the score value 
